...
| R-49 | In PR mode, deepreview must run a post-delivery fresh Codex prompt that generates a comprehensive top summary and prepends it above the deterministic detailed PR artifact body via PR edit. | `internal/deepreview/orchestrator.go`, `prompts/delivery/pr-description-summary.md`, `docs/spec.md`, `docs/architecture.md`, `docs/decisions.md` |
