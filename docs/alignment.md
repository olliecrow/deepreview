...
| R-20 | Codex is trusted as the main judge for review/execute decisions; round status files are traceability artifacts, while round-loop control is change-driven. | `docs/spec.md`, `docs/architecture.md`, `docs/decisions.md` |
...
| R-27 | If an execute round produces no repository changes, stop the round loop. | `docs/spec.md`, `docs/architecture.md`, `docs/decisions.md` |
