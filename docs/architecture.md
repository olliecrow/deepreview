...
- `pr` mode (default): create/push delivery branch, open PR into source branch, then run one fresh Codex post-delivery prompt to generate a detailed final PR description and update the PR body via `gh pr edit`
