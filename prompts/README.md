...
- In PR mode, run one Codex PR-preparation stage and then a bounded privacy-remediation Codex stage before final push/PR actions.
...
- `prompts/delivery/pr-prepare.md`: pre-delivery PR preparation template (PR mode only, single pass).
