...
## Goal
Assess whether the reviewed candidate is locally merge-ready and safe for deepreview to publish after final orchestrator-owned validation.
...
6. In `pr` mode:
   ...
   - if you identify a blocker that would require tracked-code edits or history cleanup to fix, do not fix it here; report it via `incomplete` / `incomplete_reason`
